...
<style>
body{
background-image: url(/Application_enroll_course/images/table1.jpg);
}
.box{
...
<body>
<div id="divhead">
<a href='/Application_enroll_course/Welcome' title="Home"><img alt="" src="/Application_enroll_course/images/home.png" width="100" height="100" border="0" style="float:left"></a><h1 id="head"></h1>
</div>
<div class="box">
